  ...
  render() {
    ...
    return (
      <div class="random-gif">
        ...
        <button onClick={this.showPic}>Give me a Pic!</button>
        <img
          src="https://images.contentstack.io/v3/assets/blt731acb42bb3d1659/bltce19ac18cfc17bb2/5efa74cfe953921d7fdeaa4c/01_Ask_Riot_Banner_Yuumi.jpg"
          name="getPic"
          style="width:500px"
        />
      </div>
