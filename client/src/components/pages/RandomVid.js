...
export default class RandomVid extends Component {
    ...
    function showPic() {
        document.getPic.src = "https://www.thoughtco.com/thmb/mik7Z00SAYN786BQbieXWOzZmc8=/2121x1414/filters:fill(auto,1)/lotus-flower-828457262-5c6334b646e0fb0001dcd75a.jpg";
    }*/
    constructor(props) {
        super(props);
        this.state = {
